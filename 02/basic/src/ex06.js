...
export default function example(){
    ...
    function draw(){
        ...
        const delta = clock.getDelta(); // 드로우가 실행될때마다 시간차를 계산한다(이전드로우에서, 이번 드로우에서 실행되는 시간 차)
        console.log(delta);
        // getElapsedTime, getDelta 를 같이 쓰면 안된다. 꼬인다.
        ...
        mesh.position.y += delta; // 프레임이 로드 되는 속도는 화면 주사율에 따라 달라짐,
